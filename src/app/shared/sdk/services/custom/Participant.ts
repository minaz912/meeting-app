...
export class ParticipantApi extends BaseLoopBackApi {
  ...
  public findByIdAccessTokens(id: any, fk: any): Observable<any> {
    ...
    "/Participants/:id/accessTokens/:fk";
   ...
   * @param {any} id Participant id
   *
   * @param {any} fk Foreign key for meetings
   *
   * @returns {object} An empty reference that will be
   *   populated with the actual data once the response is returned
   *   from the server.
   ...
   * </em>
   */
  public findByIdMeetings(id: any, fk: any): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Participants/:id/meetings/:fk";
    let _routeParams: any = {
      id: id,
      fk: fk
    };
   ...
   * This method returns no data.
   */
  public destroyByIdMeetings(id: any, fk: any): Observable<any> {
    let _method: string = "DELETE";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Participants/:id/meetings/:fk";
    let _routeParams: any = {
   ...
   * </em>
   */
  public updateByIdMeetings(id: any, fk: any, data: any = {}): Observable<any> {
    let _method: string = "PUT";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Participants/:id/meetings/:fk";
    let _routeParams: any = {
   ...
   * </em>
   */
  public linkMeetings(id: any, fk: any, data: any = {}): Observable<any> {
    let _method: string = "PUT";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Participants/:id/meetings/rel/:fk";
    let _routeParams: any = {
      id: id,
      fk: fk
    };
   ...
   * This method returns no data.
   */
  public unlinkMeetings(id: any, fk: any): Observable<any> {
    let _method: string = "DELETE";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Participants/:id/meetings/rel/:fk";
    let _routeParams: any = {
   ...
   * </em>
   */
  public existsMeetings(id: any, fk: any): Observable<any> {
  ...
  /**
   * Queries accessTokens of Participant.
   *
   * @param {any} id Participant id
   *
   * @param {object} filter 
  ...
  /**
   * Counts accessTokens of Participant.
   *
   * @param {any} id Participant id
   *
  ...
  public countAccessTokens(id: any, where: any = {}): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Participants/:id/accessTokens/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * Queries meetings of Participant.
   *
   * @param {any} id Participant id
   *
   * @param {object} filter 
   ...
   * </em>
   */
  public getMeetings(id: any, filter: LoopBackFilter = {}): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Participants/:id/meetings";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
   ...
   * </em>
   */
  public createMeetings(id: any, data: any = {}): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Participants/:id/meetings";
    let _routeParams: any = {
   ...
   * This method returns no data.
   */
  public deleteMeetings(id: any): Observable<any> {
    let _method: string = "DELETE";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Participants/:id/meetings";
    let _routeParams: any = {
  ...
  /**
   * Counts meetings of Participant.
   *
   * @param {any} id Participant id
   *
   * @param {object} where Criteria to match model instances
   ...
   *  - `count` – `{number}` - 
   */
  public countMeetings(id: any, where: any = {}): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Participants/:id/meetings/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
   ...
   * </em>
   */
  public createManyMeetings(id: any, data: any[] = []): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Participants/:id/meetings";
    let _routeParams: any = {
  ...
  /**
   * @ngdoc method
   * @name sdk.Participant#getCurrent
   * @methodOf sdk.Participant
   *
   * @description
   *
  ...
  public getCurrent(): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() + "/Participants" + "/:id";
   ...
   * call to {@link sdk.Participant#login} or
   * {@link sdk.Participant#getCurrent}. Return null when there
   ...
   * call to {@link sdk.Participant#login}
   *
  ...
  /**
   * @name sdk.Participant#isAuthenticated
   *
  ...
  /**
   * @name sdk.Participant#getCurrentId
   *
